module MyTestMall/mallBase/client

go 1.20

require (
	MyTestMall/mallBase/basics v0.0.0-20230317014743-2b61d034d94d
...
replace (
	MyTestMall/mallBase/basics => ../basics
	MyTestMall/mallBase/server => ../server
