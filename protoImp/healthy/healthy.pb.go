...
func (m *ReqBodyParamPage) GetPage() *PageInfo {
	if m != nil {
		return m.Page
	}
	return nil
...
func (m *ReqFoodPage) GetPage() *PageInfo {
	if m != nil {
		return m.Page
	}
	return nil
...
func (m *ReqSportsPage) GetPage() *PageInfo {
	if m != nil {
		return m.Page
	}
	return nil
...
type PBHealthyServant interface {
	...
	BodyParamDelete(input BodyParam) (output Result, err error)
	...
	FoodDelete(input Food) (output Result, err error)
	...
	SportsDelete(input Sports) (output Result, err error)
}
...
type PBHealthyServantWithContext interface {
	...
	BodyParamDelete(ctx context.Context, input BodyParam) (output Result, err error)
	...
	FoodDelete(ctx context.Context, input Food) (output Result, err error)
	...
	SportsDelete(ctx context.Context, input Sports) (output Result, err error)
}
...
func (obj *Healthy) BodyParamDelete(input BodyParam, opts ...map[string]string) (output Result, err error) {
	ctx := context.Background()
	return obj.BodyParamDeleteWithContext(ctx, input, opts...)
}

// BodyParamDeleteWithContext is client rpc method as defined
func (obj *Healthy) BodyParamDeleteWithContext(ctx context.Context, input BodyParam, opts ...map[string]string) (output Result, err error) {
	var inputMarshal []byte
	inputMarshal, err = proto.Marshal(&input)
	if err != nil {
		return output, err
...
func (obj *Healthy) FoodDelete(input Food, opts ...map[string]string) (output Result, err error) {
	ctx := context.Background()
	return obj.FoodDeleteWithContext(ctx, input, opts...)
}

// FoodDeleteWithContext is client rpc method as defined
func (obj *Healthy) FoodDeleteWithContext(ctx context.Context, input Food, opts ...map[string]string) (output Result, err error) {
	var inputMarshal []byte
	inputMarshal, err = proto.Marshal(&input)
	if err != nil {
		return output, err
...
func (obj *Healthy) SportsDelete(input Sports, opts ...map[string]string) (output Result, err error) {
	ctx := context.Background()
	return obj.SportsDeleteWithContext(ctx, input, opts...)
}

// SportsDeleteWithContext is client rpc method as defined
func (obj *Healthy) SportsDeleteWithContext(ctx context.Context, input Sports, opts ...map[string]string) (output Result, err error) {
	var inputMarshal []byte
	inputMarshal, err = proto.Marshal(&input)
	if err != nil {
		return output, err
